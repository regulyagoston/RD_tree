...
function mc_tree_fRDD_np_unified( type , sigmaY , N , SE1, MC, path )
...
% Test Sample
N_te = 10000;
[ ~ , Z_te , ~ , ~, cutoff , chiY , ~ , predVals , trueTree ] = fRDDtreeDGPs( type , MC , N_te , sigmaY , 778 );
...
nStr = num2str( N );
filename = horzcat( path, '/fRDD_np_uni_' , type , '_' , sStr , '_' , nStr , cv_str );
