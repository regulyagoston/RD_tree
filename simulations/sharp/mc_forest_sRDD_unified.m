...
function mc_forest_sRDD_unified( type , sigmaY , N , SE1 , MC, path )
...
% Test Sample
N_te = 10000;
[ ~ , Z_te , ~ , cutoff , chiY ] = sRDDtreeDGPs( type , MC , N_te , sigmaY , 778 );
...
nStr = num2str( N );
filename = horzcat( path, '/sRDD_np_uni_' ,...
...
filename = horzcat( path, '/sRDD_forest_uni_' , type , '_' , sStr , '_' , nStr , cv_str );
