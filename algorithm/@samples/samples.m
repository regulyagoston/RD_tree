   ...
   properties ( Hidden )
    ...
    methods
        function obj = samples( obj_optCART , Y , Z , varargin )
            ...
            addParameter( iP , 'forest_sample_0' , false, @( x )islogical( x ) );
            ...
            if any( strcmp( obj_optCART.model , {'linear','local'} ) )
                addParameter( iP , 'X' , [] );
            ...
            if obj_optCART.honest && ~iP.Results.forest_sample_0 %&& ~obj_optCART.forest
            ...
            if any( strcmp( obj_optCART.type , { 'CATE' , 'CLATE' } ) ) && ...
                ...
                if obj_optCART.honest && ~iP.Results.forest_sample_0
