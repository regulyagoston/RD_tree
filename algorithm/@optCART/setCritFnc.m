...
if strcmp( obj.type , 'CATE' ) && strcmp( obj.model , 'mean' ) && ...
   strcmp( obj.criteria , 'athey-imbens' ) && obj.honest
...
elseif any( strcmp( obj.type , {'CATE','CLATE' } ) ) && strcmp( obj.model , 'linear' ) && ...
   strcmp( obj.criteria , 'RDD' ) && obj.honest
...
elseif any( strcmp( obj.type , {'CATE','CLATE' } ) ) && strcmp( obj.model , 'local' ) && ...
   strcmp( obj.criteria , 'RDD' ) && obj.honest

    obj.crit_split = @treat_local_lbl_RDD_SPLIT_crit;
    obj.crit_ios   = @treat_local_lbl_RDD_crit;
    obj.crit_oos   = @treat_local_lbl_RDD_crit;
    
elseif strcmp( obj.type , 'prediction' ) && strcmp( obj.model , 'mean' ) && ...
        strcmp( obj.criteria , 'MSE' ) && ~obj.honest
    ...
    error('optCART:setCritFnc:incorrectType:val',...
          ['Invalid setup for optCART, use one of the following: \n',...
           ...
           '    model = mean, criteria = athey-imbens \n',...
           'or \n',...
